...
def get_args():
    ...
    required.add_argument("-m", help=m_desc, default=DETECTOR_PATH)
    optional.add_argument("-c", help=c_desc, default=None)
    optional.add_argument("-d", help=d_desc, default="CPU")
    optional.add_argument("-pt", help=pt_desc, default=0.5)
    optional.add_argument("-letters", help=letters_desc, default="  0123456789abcdefghijklmnopqrstuvwxyz")
